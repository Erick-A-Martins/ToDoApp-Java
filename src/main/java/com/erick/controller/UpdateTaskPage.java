                        ...
                        <body style='display: flex; justify-content:center;'>
                            <div style='display:flex; flex-direction: column; align-items: center; max-width:20rem'>
                                ...
                                <form method='get' action='/update' style='font-family: monospace; font-size: 1rem; width: 17rem;'>
                                    ...
                                    <input  type='text' name='title' style='width:100%; margin-bottom: 1rem;' id='title' value='""" + task.title() + """
                                    '><label for='description'>Descrição:</label>
                                    <input type='text' name='description' style='width:100%; margin-bottom: 1rem;' id='description' value='""" + task.description() + """
                                    '><label for='completed'>Concluída:</label>
                                    <input type='checkbox' name='completed' style='width:100%; margin-bottom: 1rem;' id='completed'""" + (task.completed() ? "checked" : "") + """
